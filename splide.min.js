...
!(function (n, t) {
    ...
    function Xn(t, n, e, i) {
        ...
        function f() {
            if (!c) {
                if (((s = t ? cn((u() - o) / t, 1) : 1), e && e(s), 1 <= s && (n(), (o = u()), i && ++a >= i)))
                    return l();
                p(f);
            }
        }
    ...
    function zt(o, e, t, r) {
        ...
        function P() {
            ...
            i ||
                ((n = o.index),
                (t = C()) !== J(r, bt) && (L(r, bt, t), j(r, Jn, (d && t) || ""), s(t ? Cn : kn, k)),
                (function () {
                    var n = (function () {
                            if (o.is(Mt)) return C();
    ...
    var Xt = Object.freeze({
            ...
            Scroll: function (r, s, u) {
                ...
                function w(n, t, e, i) {
                    ...
                    g(o + n), r.is(At) && !e && v() && ((m *= 0.6), dn(n) < 10 && y(h(v(!0)), 600, !1, void 0, !0));
                }
                function E() {
                    c && c.cancel();
                }
                                        ...
                                        return (
                                            ...
                                            gn(n) *
                                                cn(
                                                    ...
                                                    c ? 1 / 0 : i.Layout.listSize() * (u.flickMaxPages || 1)
                                                )
                                        );
                                    })(t),
                            ...
                            l.pagination &&
                                ...
                                (function () {
                                    var n = f.length,
                                        ...
                                        o = m() ? n : ln(n / i);
                                    P(
                                        (d = g.pagination || H("ul", t.pagination, g.track.parentElement)),
                                        (p = ht + "--" + E())
                                    ),
                                        j(d, qn, "tablist"),
                                        j(d, Vn, e.select),
        ...
        return {
            ...
            start: function (n, t) {
                ...
                1 <= dn(e - i) && 1 <= o
                    ? u.useScroll
                        ? f.scroll(e, o, !1, t)
                        : (l("transform " + o + "ms " + u.easing), c.translate(e, !0), (s = t))
                    : (c.jump(n), t());
            },
            cancel: i,
        };
        ...
        return (
            ...
            (n.sync = function (n) {
                return (
                    ...
                    this.state.is(3) && (this._C.Sync.remount(), n.Components.Sync.remount()),
                    this
                );
            }),
            (n.go = function (n) {
